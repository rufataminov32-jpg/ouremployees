...
def format_message(props):
    fio = get_text(props.get("ФИШ", {}), "title")
    lavozim = get_text(props.get("Lavozim", {}), "rich_text")
    telefon = get_text(props.get("Telefon", {}), "phone_number")
    pinfl = get_text(props.get("PINFL", {}), "rich_text")
    sana = get_text(props.get("Ish boshlagan sana", {}), "date")
    maosh = get_text(props.get("Maosh istagi", {}), "number")
